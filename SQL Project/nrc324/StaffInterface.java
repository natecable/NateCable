...
class StaffInterface {
    public static void Staff(Connection con) throws SQLException, IOException, java.lang.ClassNotFoundException {
        Scanner in = new Scanner(System.in);
        System.out.println("Welcome Staff!");
        // Start Staff Interface
        boolean ex = false;
        do {
            int option = menu(in);
            do {
                if (option == 1) {
                    ...
                    System.out.println("STAFF LOGOUT! Have a nice day!");
                    ex = true;
                }
                break;
            } while (true);
